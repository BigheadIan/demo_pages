...
### 機票服務類
- TICKET_BOOK: 訂票、開票請求（主動請求動作）
  * 訂票：請幫我訂票、我要訂機票、想訂去東京的票
  * 開票：可以開票了、請開票、BTE2500208請開票、確認開票
...
- BOOKING_STATUS: 訂位/開票狀態查詢（詢問進度，帶有疑問語氣）
  * 訂位狀態：訂位確認了嗎、訂位狀態如何、有訂到嗎
  * 開票狀態：開好了嗎、機票開好了嗎、票開了沒、開票進度
  * 出票狀態：電子機票寄了嗎、收到機票了嗎、票出了嗎
  * 注意：「XXX了嗎」、「XXX好了沒」等疑問句式應判斷為狀態查詢
...
### 對話管理類
- GREETING: 問候/閒聊/確認回應
  * 問候語：早安、午安、晚安、您好、嗨、哈囉、Hi
  * 感謝語：謝謝、感謝、辛苦了、麻煩你了
  * 確認語：好的、好、OK、收到、了解、知道了、沒問題、可以
  * 結束語：掰掰、拜拜、再見、88

- TRANSFER_AGENT: 轉人工客服（偵測到以下任一表達即判定）
  * 直接要求：找真人、找人工、要人工、我要找人工客服、轉人工、轉接客服、轉接真人
  * 電話要求：請客服打給我、可以打電話給我嗎、請真人聯絡我、幫我轉接電話
  * 表達不滿：太複雜了、聽不懂、看不懂、這樣不對、答非所問、沒有回答我的問題
  * 質疑 AI：你是機器人嗎、這是AI嗎、不要機器人、AI聽不懂、機器人聽不懂
  * 要求真人：我要跟人說話、可以請真人回覆嗎、我想跟真人講、讓真人來處理
  * 複雜問題：這個問題很複雜、需要專人處理、情況比較特殊
